...
export default function Overview({ CoinInfo }) {
    ...
    return (CoinInfo && Pos &&
        <div className='w-full px-7 py-8 flex flex-col gap-y-8 rounded-xl bg-white flex-wrap max-[768px]:px-2'>
            <div className='flex flex-col gap-y-8'>
                <p className='text-3xl font-semibold'>Performance</p>
                <div className='flex flex-col gap-y-4 justify-center flex-wrap'>
                    <div className='flex items-center flex-wrap gap-x-2'>
                        <div className='w-fit flex flex-col items-start min-h-[50px]'>
                            <p className='text-sm'>Today's Low</p>
                            <p className='text-lg font-semibold'>{CoinInfo?.market_data?.low_24h?.usd}</p>
                        </div>
                        <div className='flex items-center min-h-[50px] flex-1'>
                            <div className='bg-gradient-to-r from-red-400 via-yellow-400 to-green-400 w-full h-[5px] flex flex-col gap-y-2'>
                        ...
                        <div className='w-fit flex flex-col items-end min-h-[50px]'>
                    ...
                    <div className='flex items-center flex-wrap gap-y-4 gap-x-2'>
                        <div className='w-fit min-h-[50px] flex flex-col items-start'>
                            <p className='text-sm'>52W's Low</p>
                            <p className='text-lg font-semibold'>{CoinInfo?.market_data?.low_24h?.usd}</p>
                        </div>
                        <div className='min-h-[50px] flex items-center flex-1'>
                            <div className='bg-gradient-to-r from-red-400 via-yellow-400 to-green-400 w-full h-[5px] flex flex-col gap-y-2'>
                                {Pos.pos1 &&
            ...
            <div className='flex flex-col gap-y-8 flex-wrap'>
                ...
                <div className='flex justify-between font-medium flex-wrap'>
                    <div className='min-[850px]:basis-[45%] w-full'>
